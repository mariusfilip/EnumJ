 ...
 * @author Marius Filip
 */
public class ZipAnyEnumeratorTest {
    
    public ZipAnyEnumeratorTest() {
    }
    ...
    public void setUp() {
        ...
        leftZipped = new ZipAnyEnumerator(shortIterator, longIterator);
        rightZipped = new ZipAnyEnumerator(longIterator, shortIterator);
    }
    int shortLen = 3;
    int longLen = 5;
    Iterator<Integer> shortIterator;
    Iterator<Integer> longIterator;
    ZipAnyEnumerator<Integer, Integer> leftZipped;
    ZipAnyEnumerator<Integer, Integer> rightZipped;
